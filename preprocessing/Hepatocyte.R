...
extracted_expression_file = "../data/ARCHS4/Hepatocyte_expression_matrix.tsv"
extracted_processed_expression_file = "../preprocessing/ARCHS4_processed/Hepatocyte_expression_matrix_preprocessed.tsv"
meta_file <- "../data/ARCHS4/Hepatocyte_meta_data.tsv"
